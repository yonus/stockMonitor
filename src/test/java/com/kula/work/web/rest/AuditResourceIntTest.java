...
import com.kula.work.config.audit.AuditEventConverter;
import com.kula.work.domain.PersistentAuditEvent;
import com.kula.work.repository.PersistenceAuditEventRepository;
import com.kula.work.service.AuditEventService;
...
@SpringBootTest(classes = NetasWork2App.class)
@Transactional
